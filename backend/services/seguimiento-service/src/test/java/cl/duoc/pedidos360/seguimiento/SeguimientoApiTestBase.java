...
abstract class SeguimientoApiTestBase {
    ...
    Seguimiento guardar(Long pedidoId, EstadoSeguimiento estado) {
        return seguimientos.saveAndFlush(new Seguimiento(pedidoId, estado));
    }
}
